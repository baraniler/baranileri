...
.setColor('#00ff00')
.setDescription('Bildiriniz başarıyla iletildi :istek: \nEn Yakın Zamanda <#799604323197255701>  Kanalından Cevap Vereceğiz. :dikat:')
...
client.channels.cache.get('799604323197255701').send(embed2); //Mesajın Gideceği Kanal ID 
